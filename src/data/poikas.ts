...
export const poikasData: PoikasDataRaw = {
  seasons: [
    ...poikasPrevious,
    {
      ...
      description: "Finished the regular season as the #1 seed, won the playoff semifinal 4-0 over Liquid Gold, and came up just short in the championship.",
      photos: [],
      sidebar: "",
      roster: [
        "Asa Storm",
      ...
      games: [
        ...
        },
        {
          ...
          notable: "Solid game, good shutout win",
          goalie: "Jamon Holmgren",
          stats: {
            "Myron Kinnunen": { goals: 1 },
            "Logan Matson": { goals: 1, assists: 2 },
            "Reade Samuelson": { goals: 1, assists: 1, penalties: 1 },
            "Ethan Kulla": { goals: 1 },
            "Oren Matson": { assists: 2 },
        ...
        },
        {
          ...
          notable: "Daniel hat trick, 2nd shutout in a row",
          goalie: "Jamon Holmgren",
          stats: {
            "Daniel Kulla": { goals: 3 },
            "Dan Warren": { goals: 1, assists: 1 },
            "Zacharias Snellman": { goals: 2, assists: 1, penalties: 2 },
            "Logan Matson": { assists: 1 },
            "Cedric Holmgren": { assists: 1, penalties: 1 },
            "Ethan Kulla": { penalties: 1 },
          },
          shotsUs: 22,
          shotsThem: 13,
        },
        {
          ...
          notable: "Daniel back to back hat tricks!",
          goalie: "Jamon Holmgren",
          stats: {
            "Daniel Kulla": { goals: 3, assists: 1 },
            "Logan Matson": { goals: 2 },
            "Myron Kinnunen": { goals: 1, assists: 1 },
            "Dan Warren": { goals: 1, assists: 2 },
            "Cedric Holmgren": { assists: 1 },
        ...
        },
        {
          ...
          notable: "Clinched #1 seed, scored on shots 27, 30, 31",
          goalie: "Jamon Holmgren",
          stats: {
            "Oren Matson": { goals: 1 },
            "Peter Tapio": { goals: 1 },
            "Zacharias Snellman": { goals: 1, assists: 1 },
            "Ethan Kulla": { assists: 1 },
        ...
        },
        {
          ...
          notable: "Playoff semifinal — going to the championship again!",
          goalie: "Jamon Holmgren",
          stats: {
            "Oren Matson": { goals: 1, assists: 1 },
            "Daniel Kulla": { goals: 1 },
        ...
        },
        {
          ...
          notable: "Championship game — great crowd. Scored two shorthanded goals.",
          goalie: "Jamon Holmgren",
          stats: {
            "Dan Warren": { goals: 2 },
            "Zacharias Snellman": { goals: 1, assists: 1 },
            "Asa Storm": { goals: 1, assists: 1, penalties: 1 },
            "Jamon Holmgren": { assists: 1 },
            "Oren Matson": { assists: 1 },
            "Daniel Kulla": { penalties: 1 },
    ...
    },
    {
      ...
      playoffs: "eliminated-championship",
      description: "Finished first in the regular season at 11-3-1, won the playoff semifinal, and fell 3-2 in overtime in the championship.",
      photos: [],
      sidebar: "",
      roster: [
        "Brad Wuori",
      ...
      games: [
        ...
        },
        {
          ...
          notable: "Championship game — overtime loss.",
        },
      ],
    },
    {
      ...
      description: "A mixed, mostly-Rec summer exhibition series against the Slavic Peeps. There were no playoffs or championship.",
      photos: [],
      sidebar: "",
      roster: [
        "Brad Wuori",
      ...
      games: [
        {
          ...
          notable: "Summer exhibition series, mixed league mostly Rec. Joel scored the winner with two seconds left.",
          goalie: "Jamon Holmgren",
          stats: {
            "Joel Mattila": { goals: 2, assists: 1 },
        ...
        },
        {
          ...
          notable: "Summer exhibition series tied at 1-1. An empty netter made it 3-6 late.",
          goalie: "Jamon Holmgren",
          stats: {
            "Cedric Holmgren": { goals: 1 },
            "Oren Matson": { goals: 1 },
        ...
        },
        {
          ...
          notable: "Wild back-and-forth game. Finished the series 2-1, likely.",
          goalie: "Jamon Holmgren",
          stats: {
            "Peter Tapio": { goals: 2 },
            "Oren Matson": { goals: 1, assists: 1 },
            "Zacharias Snellman": { goals: 1 },
            "Shane Matson": { goals: 1, penalties: 1 },
            "Brad Wuori": { assists: 1 },
            "Dan Warren": { assists: 3 },
        ...
        },
        {
          ...
          result: "won",
          sisu: "Myron Kinnunen",
          notable: "Date not recorded.",
          goalie: "Jamon Holmgren",
          stats: {
            Marty: { goals: 2, assists: 1 },
        ...
        },
        {
          ...
          notable: "Reported as a 3-6 loss. Other game data was not recorded.",
          goalie: "Mike Marsh",
        },
        {
          vs: "Slavic Peeps",
      ...
      games: [
        {
          ...
          notable: "Some assists are unrecorded.",
          goalie: "Jim (Bad Czech)",
          stats: {
            "Zacharias Snellman": { goals: 2 },
            "Daniel Kulla": { goals: 2, assists: 2 },
            "Mike Kulla": { goals: 1 },
            "Ivan Kulla": { goals: 1 },
            "Ryan Tapio": { goals: 1 },
            "Joel Mattila": { assists: 1 },
            "Peter Tapio": { assists: 2 },
          },
          shotsUs: 27,
          shotsThem: 15,
        },
        {
          ...
          stats: {
            ...
            "Shane Matson": { goals: 1, assists: 1 },
            "Zacharias Snellman": { goals: 1, assists: 2 },
            "Levi Estola": { goals: 1, penalties: 1 },
            "Logan Matson": { goals: 1 },
            "Cedric Holmgren": { assists: 1 },
            "Myron Kinnunen": { assists: 2 },
            "Matix Sarkela": { assists: 1 },
          },
          shotsUs: 33,
          shotsThem: 10,
        },
        {
          ...
          notable: "Almost scored on a 3-on-5 penalty kill.",
          goalie: "Jamon Holmgren",
          stats: {
            "Levi Estola": { goals: 1 },
            "Zacharias Snellman": { goals: 2 },
            "Asa Storm": { goals: 2 },
            "Myron Kinnunen": { assists: 1, penalties: 1 },
            "Shane Matson": { assists: 1 },
            "Daniel Kulla": { assists: 1 },
            "Ryan Tapio": { assists: 1 },
            "Logan Matson": { assists: 1 },
            "Mike Kulla": { penalties: 1 },
            "Matix Sarkela": { penalties: 1 },
          },
          shotsUs: 35,
          shotsThem: 16,
        },
        {
          ...
          notable: "Brenna Matson's first game as a Poika.",
          goalie: "Jamon Holmgren",
          stats: {
            "Dan Warren": { goals: 1, assists: 1, penalties: 1 },
            "Logan Matson": { goals: 2 },
            "Daniel Kulla": { goals: 2 },
            "Brenna Matson": { assists: 1 },
            "Cedric Holmgren": { assists: 1 },
            "Zacharias Snellman": { assists: 1 },
            "Joel Mattila": { assists: 1 },
    ...
    },
    {
      ...
      seasonName: "Fall",
      leagueName: "CC",
      schedule: "https://mountainview.ezleagues.ezfacility.com/teams/3235401/Suomi-Poikas-CC.aspx",
      playoffs: "pending",
      description: "Jamon Holmgren returns as the full-time CC goalie. The Poikas opened the season with three straight overtime games.",
      photos: [],
      sidebar: "",
      roster: ["Caleb Aring", "Jamon Holmgren", "Jared Matson", "Kevin Sarkela", "Nels Tapio", "Russ Tapio", "Ryan Schaefer", "Sam Balto", "Scott Daniels", "Ward Pearson"],
      games: [
        {
          vs: "CCCP",
          us: 3,
          ...
          notable: "Overtime win — first game of the season! Ward's assist is unconfirmed.",
          goalie: "Jamon Holmgren",
          stats: {
            "Kevin Sarkela": { goals: 1 },
            "Sam Balto": { goals: 1, penalties: 1 },
            "Ward Pearson": { goals: 1, penalties: 1 },
          },
          shotsUs: 24,
          shotsThem: 34,
        },
        {
          ...
          notable: "Hung tough but fell in the shootout. One assist is unrecorded.",
          goalie: "Jamon Holmgren",
          stats: {
            "Kevin Sarkela": { goals: 2, assists: 1 },
            "Russ Tapio": { goals: 1 },
            "Sam Balto": { goals: 1 },
            "Nels Tapio": { assists: 1, penalties: 1 },
            "Jared Matson": { assists: 1 },
            "Ward Pearson": { penalties: 1 },
          },
          shotsUs: 35,
          shotsThem: 25,
        },
        {
          ...
          notable: "Third shootout in a row!",
          goalie: "Jamon Holmgren",
          stats: {
  ...
  players: [
    ...
    },
    {
      number: 51,
      name: "Jamon Holmgren",
      bio: "Jamon was the first full time goalie for the Poikas from the beginning. He is now the full-time goalie for both the Rec and CC teams.",
      pos: "G",
      shoots: "R",
      born: 1981,
      ht: "6-4",
