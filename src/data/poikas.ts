...
const poikasData: PoikasDataRaw = {
    ...
    },
    {
      ...
      games: [
        ...
        },
        {
          ...
          result: "won",
          sisu: "Jamon Holmgren",
          notable: "Goals: Asa, Steve, Oren, Brad, Andrew, and Nolan. Assists: Kevin, Steve, others. Shots: 31-26.",
        }
      ],
    },
  ],
  players: [
    ...
    },
    {
      number: 63,
      name: "Jay Tapio",
      bio: "Jay grew up playing pond hockey in Michigan's upper peninsula. His steady presence on the defensive end is key to the Poikas success.",
      pos: "D",
    },
    {
      number: 26,
